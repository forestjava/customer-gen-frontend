...
import { useRegionForm } from '../../api/forms/region';
...
export const RegionDetails = () => {
  ...
  const form = useRegionForm(id);

  return (
    <Box variant='drawer'>
      <Heading className='text-lg font-bold'>Region Details</Heading>
      <Form className='form' onSubmit={form.submit}>
        
        <InputString label='Name' required={true} placeholder='' {...form.input('name')} />
        
        <InputCompany label='Company' required={true} placeholder='Select Company' {...form.input('company')} />
